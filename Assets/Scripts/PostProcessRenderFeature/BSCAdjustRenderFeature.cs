...
public class BSCAdjustRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class BSCAdjustRenderPass : ScriptableRenderPass
    {
        ...
        public BSCAdjustRenderPass(RenderPassEvent passEvent, Material material, int passMatIndex, string tag) {
    ...
    public override void Create()
    {
        ...
        renderPass = new BSCAdjustRenderPass(setting.passEvent, setting.material, setting.matPassIndex, name);
    }
